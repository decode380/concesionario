        ...
        foreach($datacar as $row){
            ...
            if(isset($dataseller)){
                $table .= '
                    ...
                    <td>'.$row->vehestado.'</td>
                    <td>'.$row->vehprecio.'</td>
                    <td><a style="color:#ffff;" href="" onclick="event.preventDefault(); view_seller_data(\''.$dataseller->datnombre.'\',\''.$dataseller->datapellido.'\',\''.$dataseller->datelefono.'\');">Ver datos del vendedor</a></td>
                    </tr>
                ';
            }
        }
